...
- (UIButton *)doneButton
{
    if (_doneButton == nil)
    {
        ...
        [_doneButton setTitle:L(@"完成") forState:UIControlStateNormal];
...
//            
//            [_doneButton setImage:[UIImage imageNamed:@"DoneUp3"] forState:UIControlStateNormal];
//            
//            [_doneButton setImage:[UIImage imageNamed:@"DoneDown3"] forState:UIControlStateHighlighted];
//        }
