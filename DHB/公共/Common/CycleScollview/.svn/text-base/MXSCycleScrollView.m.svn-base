...
- (void)getDisplayImagesWithCurpage:(NSInteger)page {
    NSInteger pre1 = [self validPageValue:0];
    ...
    NSInteger last = [self validPageValue:0];
...
- (void)setAfterScrollShowView:(UIScrollView*)scrollview  andCurrentPage:(NSInteger)pageNumber
{
    ...
    [twoLabel setTextColor:HEX_RGB(0xbebebe)];
    ...
    [currentLabel setTextColor:HEX_RGB(0x333333)];//选中颜色
    ...
    [threeLabel setTextColor:HEX_RGB(0xbebebe)];
    ...
    [fourLabel setTextColor:HEX_RGB(0xbebebe)];
    [fourLabel setTextAlignment:NSTextAlignmentCenter];
    [fourLabel setHidden:YES];
    
    UILabel *bottomLabel = (UILabel*)[[scrollview subviews] objectAtIndex:pageNumber+5];
