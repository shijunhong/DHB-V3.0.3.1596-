//
//  DHBProductImgEightBannerView.m
//  DHB
//
...
#import "DHBGoodsImgEightBannerView.h"
#define KBannerViewFrame            CGRectMake(0, 0, SCREEN_WIDTH, self.frame.size.height)
#define kBannerPageControlFrame     CGRectMake(0, self.frame.size.height-9, SCREEN_WIDTH, 3)
@implementation DHBGoodsImgEightBannerView
...
- (UIPageControl *)pageControl {
    if (!_pageControl) {
        ...
        if (IOS6_OR_LATER) {
            ...
            _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRGBHex:0xcbcaca];
        }
...
//        floorOrderNO = dto.orderNO;
    ...
    else
    {
        ...
        [imgView setImage:[UIImage imageNamed:@"首页banner-W750"]];
